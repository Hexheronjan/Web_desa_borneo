...
export function PageTitle({ fitur, modul, color, rightElement }: PageTitleProps) {
  return (
    <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div>
        <div className="flex items-center gap-3">
          ...
          />
          <h2 className="text-xl md:text-2xl font-extrabold text-slate-800 leading-tight">{fitur}</h2>
        </div>
